...
echo "GET        /doYouKnowCountryOfNationality                        controllers.individual.DoYouKnowCountryOfNationalityController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /doYouKnowCountryOfNationality                        controllers.individual.DoYouKnowCountryOfNationalityController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeDoYouKnowCountryOfNationality                  controllers.individual.DoYouKnowCountryOfNationalityController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeDoYouKnowCountryOfNationality                  controllers.individual.DoYouKnowCountryOfNationalityController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
