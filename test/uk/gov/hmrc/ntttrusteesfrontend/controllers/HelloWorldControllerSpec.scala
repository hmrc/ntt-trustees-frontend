package uk.gov.hmrc.ntttrusteesfrontend.controllers
...
import uk.gov.hmrc.ntttrusteesfrontend.config.AppConfig
import uk.gov.hmrc.ntttrusteesfrontend.views.html.hello_world
